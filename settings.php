...
$settings->add(new admin_setting_configtext('block_superiframe/url', get_string('url','block_superiframe'),  // here in block_superiframe/url, /url is the setting name
